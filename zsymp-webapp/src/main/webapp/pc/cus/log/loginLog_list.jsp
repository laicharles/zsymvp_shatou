...
<div class="wraper sidebar-full">
    ...
    <div class="container-fluid">
        <!--主体内容-->
        <h2 class="title_class">后台操作日志</h2>
...
<script>
    ...
    $(document).ready(function () {
	    jQuery("#datagrid").jqGrid({
	       	url: '${pageContext.request.contextPath}/cus/loginLogGrid.do',
	       	mtype: "GET",
            contentType: "application/json",
            datatype: "json",
            colModel:[
      		       	{ label: '选择', name: 'id', key: true,hidden:true},
      	     		{ label: '访问者', name: 'visitor', width: 200},
      	     		{ label: '登录时间', name: 'loginTime', width: 400},
      	     		{ label: '退出时间', name: 'logoutTime', width: 200}
      	    ],
      	  	rownumbers:true,
      	    viewrecords : true,
	    	height:'100%',
