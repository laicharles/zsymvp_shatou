...
<div class="wraper sidebar-full">
   <!-- 侧栏 -->
    ...
    <div class="container-fluid">
	  ...
	  <h2 class="title_class">编辑文本素材</h2>
	  <form:form action="${pageContext.request.contextPath}/cus/cTextMtrl_update.do"  modelAttribute="CTextMaterialForm"  method="POST" >
	        ...
	        <div>
		      ...
		      <textarea rows="5" cols="20" name="textContent" id="textContent" size="512">${mtrlForm.textContent }</textarea>
    ...
    $(document).ready(function(){
		$("#subBtn").click(function(){
		 ...
		 $("#returnBtn").click(function(){
			 window.location.href='${pageContext.request.contextPath}/cus/cTextMtrl_list.do?pageNo=${page }';
			});
	...
	if(checkForm()==true){
    	bootbox.confirm("确认保存？",function(result){
    		if(result==true){
					  ...
					  $("#CTextMaterialForm").ajaxSubmit(function(msg){
								if(msg.result==false){
