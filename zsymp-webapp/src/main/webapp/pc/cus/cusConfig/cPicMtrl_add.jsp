...
<div class="wraper sidebar-full">
   <!-- 侧栏 -->
    ...
    <div class="container-fluid auto-fluid">
	  ...
	  <h2 class="title_class">新增图片素材</h2>
	  
	  <form:form action="${pageContext.request.contextPath}/cus/cPicMtrl_add.do?_csrf=${_csrf.token}"  modelAttribute="CPicMaterialForm"  method="POST" enctype="multipart/form-data" >
    ...
    function setValuePicMtrl(obj){
     ...
     $(document).ready(function(){
	     ...
	     $("#returnBtn").click(function(){
	    	 window.location.href='${pageContext.request.contextPath}/cus/cPicMtrl_list.do?pageNo=1';
			});
