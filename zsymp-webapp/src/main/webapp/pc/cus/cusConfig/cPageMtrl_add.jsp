...
<div class="wraper sidebar-full">
   <!-- 侧栏 -->
    ...
    <div class="container-fluid">
	  ...
	  <h2 class="title_class">新增文章素材</h2>
	  
	  <form:form action="${pageContext.request.contextPath}/cus/cPageMtrl_add.do"  modelAttribute="CPageMaterialForm"  method="POST" >
    ...
    function setValuePageMtrl(obj){
     ...
     $(document).ready(function(){
	     ...
	     $("#returnBtn").click(function(){
	    	 window.location.href='${pageContext.request.contextPath}/cus/cPageMtrl_list.do?pageNo=1';
			});
