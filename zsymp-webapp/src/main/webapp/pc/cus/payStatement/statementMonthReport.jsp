...
<div class="wraper sidebar-full">
    ...
    <div class="container-fluid">
        <!--主体内容-->
        <h2 class="title_class">微信月统计</h2>
       
        <div class="search_field_class">
		       起始 日期：<input type="text" class="input-txt" id="date1" name="date" readonly="readonly"  style="height: 25px;"
				onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
		       截止 日期：<input type="text" class="input-txt" id="date2" name="date" readonly="readonly"  style="height: 25px;"
				onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
				<select id="userT">
...
<script>
    ...
    $(document).ready(function () {
	    jQuery("#datagrid").jqGrid({
	       	url: '${pageContext.request.contextPath}/cus/statementMonthReport.do',
	       	mtype: "GET",
            contentType: "application/json",
            datatype: "json",
            colModel:[
      		       	{ label: '收费日期', name: 'sdate', width: 100},
      		        { label: '缴费户数', name: 'usercnt', width: 80},
      		        { label: '水量', name: 'waternum', width: 80},
      		        { label: '水费', name: 'waterfee', width: 80},
      		        { label: '水费违约金', name: 'penalty', width: 80},
      	     		{ label: '污水费', name: 'sewagefee', width: 80},
      	     		{ label: '污水费滞纳金', name: 'latefee', width: 80},
      	     		{ label: '垃圾费', name: 'garbagefee', width: 80},
      	     		{ label: '总费用', name: 'totalfee', width: 80}
      	    ],
      	    viewrecords : true,
	    	height:'100%',
	    	pager : "#pagegrid",
    ...
    function search(){
    	...
    	jQuery("#datagrid").jqGrid('setGridParam',{
	       	url: '${pageContext.request.contextPath}/cus/statementMonthReport.do',
	       	postData:{'date1':date1,'date2':date2,'userType':userType},
	       	page:1
	    }).trigger("reloadGrid");
    }
    ...
    function download(){
    	...
    	location.href='${pageContext.request.contextPath}/cus/statementMonthReportDownload.do?date1='+date1+'&date2='+date2+'&userType='+userType;
    }
