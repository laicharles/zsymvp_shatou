...
<script>
    ...
    $(document).ready(function () {
	    jQuery("#datagrid").jqGrid({
	       	url: '${pageContext.request.contextPath}/cus/statementDayCount.do',
	       	mtype: "GET",
            contentType: "application/json",
            datatype: "json",
            colModel:[
      		       	{ label: '用水性质', name: 'usort'},
      		        { label: '户数', name: 'usercnt', width: 100},
      		        ...
      		        { label: '水费违约金', name: 'penalty', width: 100},
      	     		...
      	     		{ label: '总费用', name: 'totalfee', width: 150}
      	    ],
      	    viewrecords : true,
	    	height:'100%',
	    	pager : "#pagegrid",
    ...
    function download(){
    	...
    	var userType =$('#userT').val();
    	//alert(userType);
    	location.href='${pageContext.request.contextPath}/cus/statementDayCountDownload.do?date='+date+'&userType='+userType;
    }
