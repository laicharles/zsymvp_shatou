...
<div class="wraper sidebar-full">
    ...
    <div class="container-fluid">
        <h2 class="title_class">编辑营业网点</h2>
		<form:form action="${pageContext.request.contextPath}/cus/ccmsYywd_update.do" modelAttribute="YywdAddForm" method="POST">
			<input type="hidden" name="id" id="id" value="${yywdForm.id }">
			<input type="hidden" name="token" value="${yywdForm.token }">
			<div>
				<label for="nameId"><font color="red">*</font>名称：</label>
				<input type="text" name="name" id="nameId" value="${yywdForm.name }" class="general_input_class">
			</div>
			<div>
				<label for="telId"><font color="red">*</font>电话：</label>
				<input type="text" name="tel" id="telId" value="${yywdForm.tel }" class="general_input_class">
			</div>
			<div>
				<label for="descriptionId"><font color="red">*</font>营业时间：</label>
				<textarea name="description" id="descriptionId" class="textArea_class"> ${yywdForm.description }</textarea>
			</div>
			<div>
				<label for="addrId"><font color="red">*</font>地址：</label>
				<input type="text" id="addrId" name="addr" value="${yywdForm.addr }" class="pageUrl_class">
			</div>
			<div>
				<label for="addrId"><font color="red">*</font>URL：</label>
				<input type="text" id="mapUrlId" class="pageUrl_class" name="mapUrl" value="${yywdForm.mapUrl }">
			</div>
