   ...
   <!-- 侧栏 -->
    ...
    <div class="container-fluid">
	  ...
	  <form:form action="${pageContext.request.contextPath}/cus/sresource_update.do"  modelAttribute="SResourceForm"  method="POST" >
		      ...
		      <input type="text" name="resName" id="resName"  value="${resourceForm.resName }" class="general_input_class" size="64">
	      	  </div>
	      		
	      	<div>
		      <label for="parentResource.resName"  class="col-sm-2 control-label"><font color="red">*</font>上级资源：</label>
		      <input type="text"  name="parentResource.resName" id="parentResource.resName" readonly="readonly" class="text ui-widget-content ui-corner-all general_input_class" value="${resourceForm.parentResource.resName }">
		...
		<div>
	      ...
	      <input type="text" name="reqUrl" id="reqUrl"  value="${resourceForm.reqUrl }" size="256" class="pageUrl_class" >
	      </div>
	      ...
	      <div>
	 	  ...
	 	  <textarea rows="5" cols="20" name="remarks" id="remarks"  size="256" class="textArea_class"  >${resourceForm.remarks }</textarea>
	 	  </div>
