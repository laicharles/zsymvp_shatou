...
<div class="wraper sidebar-full">
   <!-- 侧栏 -->
    ...
    <div class="container-fluid">
	  ...
	  <h2 class="title_class">新增温馨提示</h2>
	  <form:form action="${pageContext.request.contextPath}/cus/reminderTemp_add.do"  modelAttribute="CReminderTempForm"  method="POST" >
		      ...
		      <input type="text" name="first" id="first" class="general_input_class" size="128">
	      	  ...
	      	  <div>
		      <label for="serviceUnits" class="col-sm-2 control-label"><font color="red">*</font>服务单位：</label>
		      <input type="text" name="serviceUnits" id="serviceUnits" class="general_input_class" size="1024">
	      	  </div>
	      	  
	      	  <div>
		      <label for="tel" class="col-sm-2 control-label"><font color="red">*</font>联系电话：</label>
		      <input type="text" name="tel" id="tel" class="general_input_class" size="512">
		  
	      	  </div>
	      	  
	      	  <div>
		      <label for="remark" class="col-sm-2 control-label"><font color="red">*</font>其他说明：</label>
		      <textarea rows="5" cols="20" name="tempRemark" id="tempRemark" size="1024"></textarea>
	      	  </div>
    ...
    $(function() {
     ...
     $(document).ready(function(){
	     ...
	     $("#returnBtn").click(function(){
	    	 window.location.href='${pageContext.request.contextPath}/cus/reminderTemp_list.do?pageNo=1';
			});
