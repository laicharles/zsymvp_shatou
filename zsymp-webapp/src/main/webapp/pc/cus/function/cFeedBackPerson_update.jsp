...
<div class="wraper sidebar-full">
    ...
    <div class="container-fluid">
        <h2 class="title_class">编辑人员</h2>
		<form:form action="${pageContext.request.contextPath}/cus/cFeedBackPerson_update.do" modelAttribute="cCommonPersonForm" method="POST">
			<div>
			...
			<div>
				<label for="nameId"><font color="red">*</font>类型：</label>
					<c:if test="${cFeedBackPersonForm.type==0}">
				  	...
				  	<c:if test="${cFeedBackPersonForm.type==1}">
						<input type="radio" name="type" value="0"  />全部接收
						<input type="radio" name="type" value="1"  checked="checked"/>仅接收保修
						<input type="radio" name="type" value="2"  />仅接收咨询
					</c:if>
					<c:if test="${cFeedBackPersonForm.type==2}">
						<input type="radio" name="type" value="0"  />全部接收
						<input type="radio" name="type" value="1"  />仅接收保修
						<input type="radio" name="type" value="2"  checked="checked"/>仅接收咨询
					</c:if>
...
<script>
    ...
    $(function(){
    	...
    	$("#returnBtn").click(function(){
    		window.location.href="${pageContext.request.contextPath}/cus/cFeedBackPerson_list.do?pageNo=1";
    	});
    	//保存
