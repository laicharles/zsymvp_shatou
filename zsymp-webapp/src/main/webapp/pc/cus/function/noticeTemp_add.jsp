...
<div class="wraper sidebar-full">
   <!-- 侧栏 -->
    ...
    <div class="container-fluid">
	  ...
	  <h2 class="title_class">新增恢复供水通知</h2>
	  <form:form action="${pageContext.request.contextPath}/cus/noticeTemp_add.do"  modelAttribute="CNoticeTempForm"  method="POST" >
		      ...
		      <input type="text" name="noticeType" id="noticeType" class="general_input_class" size="256">
	      	  </div>
	      	  
	      	  <div>
		      <label for="noticeContent" class="col-sm-2 control-label"><font color="red">*</font>恢复供水区域：</label>
		     <textarea rows="5" cols="20" name="noticeContent" id="noticeContent" size="512"></textarea>
	      	  </div>
	      	  
	      	  <div>
		      <label for="remark" class="col-sm-2 control-label"><font color="red">*</font>其他说明：</label>
		      <textarea rows="5" cols="20" name="remark" id="remark" size="512"></textarea>
	      	  </div>
    ...
    $(function() {
     ...
     $(document).ready(function(){
	     ...
	     $("#returnBtn").click(function(){
	    	 window.location.href='${pageContext.request.contextPath}/cus/noticeTemp_list.do?pageNo=1';
			});
