...
<div class="wraper sidebar-full">
    ...
    <div class="container-fluid">
        <!--主体内容-->
        <h2 class="title_class">常用openID人员</h2>
...
<script>
    $(function() {
        ...
        $("#addBtn").click(function(){
        	window.location.href="${pageContext.request.contextPath}/cus/cCommonPerson_toAdd.do";	
        });
        //编辑
    ...
    $(document).ready(function () {
	    jQuery("#datagrid").jqGrid({
	       	url: '${pageContext.request.contextPath}/cus/cCommonPersonGrid.do',
	       	mtype: "GET",
    ...
    function editRecord(){
    	...
    	if(id==""||id==null){
    		...
    		location.href='${pageContext.request.contextPath}/cus/cCommonPerson_toUpdate.do?id='+id+'&pageNo='+pageNo;
    	}
    }
    //删除记录
    function delRecord(){
    	...
    	bootbox.confirm("确定删除吗？",function(result){
			if(result==true){
				$.ajax({
     	           type:"post",
     	           url:"${pageContext.request.contextPath}/cus/cCommonPerson_delete.do",
     	           dataType:"json",
     	           async:false,
     	           ...
     	           success:function(resultList){
     	        	   if(resultList[0]=="success"){
     	        		  bootbox.alert("删除成功！",function(){
     	        			 window.location.href='${pageContext.request.contextPath}/cus/cCommonPerson_list.do?pageNo='+resultList[1];
     	        		  });
 			           }else{
