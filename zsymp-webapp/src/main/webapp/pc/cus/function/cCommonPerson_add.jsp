...
<div class="wraper sidebar-full">
    ...
    <div class="container-fluid">
		...
		<form:form action="${pageContext.request.contextPath}/cus/cCommonPerson_add.do" modelAttribute="cCommonPersonForm" method="POST">
			<div>
				<label for="openIDId"><font color="red">*</font>openID：</label>
				<input type="text" name="openID" id="openIDId" class="general_input_class">
			</div>
			<div>
