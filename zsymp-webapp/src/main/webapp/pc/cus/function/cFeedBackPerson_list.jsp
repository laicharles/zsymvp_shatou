...
<div class="wraper sidebar-full">
    ...
    <div class="container-fluid">
        <!--主体内容-->
        <h2 class="title_class">反馈人员openID</h2>
...
<script>
    $(function() {
        ...
        $("#addBtn").click(function(){
        	window.location.href="${pageContext.request.contextPath}/cus/cFeedBackPerson_toAdd.do";	
        });
        //编辑
    ...
    $(document).ready(function () {
	    jQuery("#datagrid").jqGrid({
	       	url: '${pageContext.request.contextPath}/cus/cFeedBackPersonGrid.do',
	       	mtype: "GET",
            contentType: "application/json",
            datatype: "json",
            colModel:[
      		       	{ label: '选择', name: 'id', key: true,hidden:true},
      	     		{ label: 'OpenID', name: 'openID', width: 400},
      	     		{ label: '姓名', name: 'name', width: 400},
      	     		{ label: '类型', name: 'type', width: 400},
      	    ],
      	  	rownumbers:true,
      	    viewrecords : true,
	    	height:'100%',
    ...
    function editRecord(){
    	...
    	if(id==""||id==null){
    		...
    		location.href='${pageContext.request.contextPath}/cus/cFeedBackPerson_toUpdate.do?id='+id+'&pageNo='+pageNo;
    	}
    }
    //删除记录
    function delRecord(){
    	...
    	bootbox.confirm("确定删除吗？",function(result){
			if(result==true){
				$.ajax({
     	           type:"post",
     	           url:"${pageContext.request.contextPath}/cus/cFeedBackPerson_delete.do",
     	           dataType:"json",
     	           async:false,
     	           ...
     	           success:function(resultList){
     	        	   if(resultList[0]=="success"){
     	        		  bootbox.alert("删除成功！",function(){
     	        			 window.location.href='${pageContext.request.contextPath}/cus/cFeedBackPerson_list.do?pageNo='+resultList[1];
     	        		  });
 			           }else{
 			        	  bootbox.alert("以下人员删除失败！"+resultList[0],function(){
      	        			 window.location.href='${pageContext.request.contextPath}/cus/cFeedBackPerson_list.do?pageNo='+resultList[1];
      	        		  });
 			           }
     	           }
