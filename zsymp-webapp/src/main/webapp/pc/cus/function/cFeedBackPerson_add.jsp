...
<div class="wraper sidebar-full">
    ...
    <div class="container-fluid">
        <h2 class="title_class">增加反馈人员</h2>
		<form:form action="${pageContext.request.contextPath}/cus/cFeedBackPerson_add.do" modelAttribute="cFeedBackPersonForm" method="POST">
			<div>
