...
<script>
    ...
    function setValueTextMtrl(obj){
    		...
    		$("#materialID").val(obj.id);
    	 	   $("#preview_box").append( '<div class="first_item">	<textarea style="width:100%; height:100%">'+obj.textContent+'</textarea>	'+' </div>');
    	 	  ++martrialNum;
    	}
    var martrialNum = 0;
     ...
     $(document).ready(function(){
	   ...
	   $("#previewRecord").click(function(){
		if(martrialNum==1){
    		bootbox.alert("只能选择一条文本素材！");
			return false;
    	}else{
    		$('#textMtrlModal').modal('show');
    	} 
	   });
