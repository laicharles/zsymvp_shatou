...
<head>
    ...
    <link rel="shortcut icon" href="<c:url value="/resources/js/bootstrap/img/logodyqx16.ico"/>" />
...
<div class="wraper sidebar-full">
    ...
    <div class="container-fluid">
		...
		<form:form action="${pageContext.request.contextPath}/cus/updateFeedback.do?_csrf=${_csrf.token}&openId=${feedbackForm.openId}" modelAttribute="CFeedBackManageForm" method="POST" enctype="multipart/form-data">
			...
			<div>
				<label for="nameId">标题：</label>
				<input type="text" name="customerType" id="customerTypeId" value="${feedbackForm.title }" class="general_input_class" readonly>
			</div>
			<div>
			...
			<div>
				<label for="fanUserAccountId">户号：</label>
				<input type="text" id="fanUserAccountId" value="${feedbackForm.fanUser.userAccount }" class="general_input_class" readonly>
			</div>
			<div>
			...
			<div>
			    ...
			    <c:if test="${empty emptpicNameList}">
				...
				<c:if test="${not empty emptpicNameList}">
					无照片！
				</c:if>
			</div>
			<br/>
