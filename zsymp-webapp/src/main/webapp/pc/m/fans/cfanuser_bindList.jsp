...
<script type="text/javascript">
	function add(){
		window.location.href="${pageContext.request.contextPath}/m/cfanuser_toAdd.do?openID=${openID}&token=${token}";
	}
	function search(id){
		window.location.href="${pageContext.request.contextPath}/m/cfanuser_viewBindUser.do?id="+id;
	}
</script>
...
<body>
	...
	<div id="wx-wrap-list">
		<c:forEach items="${fanUserFormList}" var="fanUserForm">
			<div class="module" onclick="search('${fanUserForm.id}')">
		...
		<div class="btn-div">
			<input type="button" onclick="add()" value="添加绑定"/>
		</div>
	</div>
